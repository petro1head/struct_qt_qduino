...
void MainWindow::writeData()
{
    ...
    this->m_stand->out();
    // Преобразование структуры в байты little endian
      QByteArray data;
      const char* timePtr = (const char*)(&(this->m_stand->data_t_speed.t));
      const char* speedPtr = (const char*)(&(this->m_stand->data_t_speed.speed));
      data.append(timePtr, sizeof(this->m_stand->data_t_speed.t));
      data.append(speedPtr, sizeof(this->m_stand->data_t_speed.speed));
      data = qToLittleEndian(data);
      this->m_serial->write(data, sizeof(Data));
...
void MainWindow::WriteFile()
{
    ...
    if (file.open(QIODevice::WriteOnly | QIODevice::Text | QIODevice:: Append))
    {
          ...
          // QString str_x = QString::number(x, 'f', 15);
          // Угловая Скорость
          //double y = this->m_stand->speed.s;
          double y = this->m_stand->data_t_speed.speed;
          // Выводим число до 4 знака после запятой
          // QString str_y = QString::number(y, 'f', 15);
